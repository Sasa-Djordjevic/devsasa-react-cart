...
const Cart = (props) => {
    ...
    const submitOrderHandler = async (userData) => {
        ...
        // https://react-food-order-cart-jan-default-rtdb.europe-west1.firebasedatabase.app//orders.json
		
        await fetch('https://react-food-order-cart-feb-default-rtdb.europe-west1.firebasedatabase.app//orders.json', {
            method: 'POST',
            body: JSON.stringify({
                user: userData,
